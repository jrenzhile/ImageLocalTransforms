...
function estimateOutput_givenLocalTransforms(obj, Ak_perPatch_34P)
  ...
  outputConstraints_3NP = mtimesx(Ak_perPatch_34P,Ibar_4NP);
  ...
  patchesNotNaN = find( sum(isnan( reshape(Ak_perPatch_34P,[],P) ),1) == 0);
  for k=patchesNotNaN
